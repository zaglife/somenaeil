...
<div class='pop_center'>
  ...
  <div id="test2">
    ...
    <div id='gh_data'>
      <div class='gh_dt'><input type="text" id="g_name1" class='gh_dt_ne' placeholder='데이터명1' size="5" maxlength="5"><input type="number" id="g_data1" class='gh_dt_vl' placeholder='데이터1'></div>
      <div class='gh_dt'><input type="text" id="g_name2"class='gh_dt_ne' placeholder='데이터명2' size="5" maxlength="5"><input type="number" id="g_data2" class='gh_dt_vl' placeholder='데이터2'></div>
