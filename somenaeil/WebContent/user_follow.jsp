...
<a onclick="userFollowPop()"></a>
  <div class="user_popup_center">
    ...
    <div id="user_popup_cont">
      ...
      <div class="user_popup_name">luv_seowoo</div>
      <div class="user_popup_comment">취업을 준비하는 사람들과 실무자간의 소통을 위한 SNS</div>
      <div class="user_popup_btn"><img src="img/noti_follow_20.png"></div>
    </div>
    
    <div id="user_popup_cont">
      <div class="user_popup_pimg"><img src="img/profile01.jpg"></div>
      <div class="user_popup_name">km_park</div>
      <div class="user_popup_comment">취업을 준비하는 사람들과 실무자간의 소통을 위한 SNS</div>
      <div class="user_popup_btn"><img src="img/noti_follow_20.png"></div>
    </div>
    ...
    <div id="user_popup_cont">
      <div class="user_popup_pimg"><img src="img/profile01.jpg"></div>
      <div class="user_popup_name">364d</div>
      <div class="user_popup_comment">취업을 준비하는 사람들과 실무자간의 소통을 위한 SNS</div>
      <div class="user_popup_btn"><img src="img/noti_follow_20.png"></div>
    </div>
    ...
    <div id="user_popup_cont">
      <div class="user_popup_pimg"><img src="img/profile01.jpg"></div>
      <div class="user_popup_name">chana</div>
      <div class="user_popup_comment">취업을 준비하는 사람들과 실무자간의 소통을 위한 SNS</div>
      <div class="user_popup_btn"><img src="img/noti_follow_20.png"></div>
    </div>
